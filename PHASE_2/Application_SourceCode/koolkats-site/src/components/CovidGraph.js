...
const CovidGraph = ({ show, startDate, endDate, location }) => {
  ...
  useEffect(() => {
    ...
    const minEndDate = moment(endDate)
      .subtract(6, "months")
      .format("YYYY-MM-DD");
  ...
  useEffect(() => {
    ...
    function getCases(endDateObj) {
      const dateString = moment(endDateObj)
        .subtract(2, "days")
        .format("M/D/YY");
  ...
  useEffect(() => {
    ...
    setVaccinationPercentage(
      ((totalVaccinations / 7900000000) * 100).toFixed(2)
    );
    ...
    >
      <Row className="justify-content-md-center">
        ...
        {vaccinationPercentage
          ...
          : "Could not find COVID-19 vaccination percentage"}
      </Row>
      <Row className="justify-content-md-center">🦠 Cases: {totalCases}</Row>
      <Row className="justify-content-md-center">💀 Deaths: {totalDeaths}</Row>
      <Row className="justify-content-md-center">

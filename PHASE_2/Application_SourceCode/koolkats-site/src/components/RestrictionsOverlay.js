...
const RestrictionsOverlay = ({ show }) => {
  const [restrictions, setRestrictions] = useState({
    ...
    VIC: {
      ACT:
        "Victoria has established a permit system for all domestic and New Zealand travel into Victoria. You must apply for a permit to enter Victoria from anywhere in Australia or New Zealand unless an exception or exemption applies to you.",
      NSW:
        "Victoria has established a permit system for all domestic and New Zealand travel into Victoria. You must apply for a permit to enter Victoria from anywhere in Australia or New Zealand unless an exception or exemption applies to you.",
      QLD:
        "Victoria has established a permit system for all domestic and New Zealand travel into Victoria. You must apply for a permit to enter Victoria from anywhere in Australia or New Zealand unless an exception or exemption applies to you.",
    ...
    QLD: {
      ACT:
        "You can enter Queensland from any Australian state or territory.There are no COVID-19 hotspots in Australia.The Queensland Border Declaration Pass system is not active. You do not need a border pass to enter Queensland.",
      NSW:
        "You can enter Queensland from any Australian state or territory.There are no COVID-19 hotspots in Australia.The Queensland Border Declaration Pass system is not active. You do not need a border pass to enter Queensland.",
      VIC:
        "You can enter Queensland from any Australian state or territory.There are no COVID-19 hotspots in Australia.The Queensland Border Declaration Pass system is not active. You do not need a border pass to enter Queensland.",
    ...
    NT: {
      ACT:
        "All arrivals to the Northern Territory (NT) must: fill in a Border Entry Form and complete 14 days of mandatory supervised quarantine at your own expense*, if you have recently been in an active declared COVID-19 hot spot. This includes children returning from a hotspot.",
      NSW:
        "All arrivals to the Northern Territory (NT) must: fill in a Border Entry Form and complete 14 days of mandatory supervised quarantine at your own expense*, if you have recently been in an active declared COVID-19 hot spot. This includes children returning from a hotspot.",
      VIC:
        "All arrivals to the Northern Territory (NT) must: fill in a Border Entry Form and complete 14 days of mandatory supervised quarantine at your own expense*, if you have recently been in an active declared COVID-19 hot spot. This includes children returning from a hotspot.",
    ...
    WA: {
      ...
      VIC:
        "All interstate arrivals must complete a G2G PASS declaration to enter WA.",
      QLD:
        "All interstate arrivals must complete a G2G PASS declaration to enter WA. Travellers from Queensland are permitted to enter WA without having to self-quarantine, but subject to strict conditions.",
      SA:
        "All interstate arrivals must complete a G2G PASS declaration to enter WA.",
      NT:
        "All interstate arrivals must complete a G2G PASS declaration to enter WA.",
  ...
  return (
    ...
    >
      <Row className="justify-content-md-center align-items-center">
        <h6 className="m-0">Travel Restrictions From </h6>
        <DropdownButton
          id="dropdown-item-button"
          title={stateFrom}
          className="mx-2"
        >
          <Dropdown.Item as="button" onClick={() => setStateFrom("--")}>
            --
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("ACT")}>
            ACT (Canberra)
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("NSW")}>
            New South Wales
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("NT")}>
            Northern Territory
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("QLD")}>
            Queensland
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("SA")}>
            South Australia
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("TAS")}>
            Tasmania
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("WA")}>
            Western Australia
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateFrom("VIC")}>
            Victoria
          </Dropdown.Item>
        </DropdownButton>
        ...
        <DropdownButton
          ...
          className="mx-2"
        >
          <Dropdown.Item as="button" onClick={() => setStateTo("--")}>
            --
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("ACT")}>
            ACT (Canberra)
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("NSW")}>
            New South Wales
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("NT")}>
            Northern Territory
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("QLD")}>
            Queensland
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("SA")}>
            South Australia
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("TAS")}>
            Tasmania
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("WA")}>
            Western Australia
          </Dropdown.Item>
          <Dropdown.Item as="button" onClick={() => setStateTo("VIC")}>
            Victoria
          </Dropdown.Item>
        </DropdownButton>
      </Row>
      ...
      {/* <Row className="mt-2">For more information, view {link.join("\n")}</Row> */}
      <Row className="justify-content-md-center mt-2">
...
const RestrictionsForState = ({ num, stateTo, restriction, link }) => {
  ...
  return (
    <Container>
      ...
      <Row>{rule ? rule : "Could not get restrictions"}</Row>
    </Container>
  );
};
